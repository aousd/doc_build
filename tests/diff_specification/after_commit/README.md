...
2. This item replaces the old third entry with completely new text
3. This item will have just one word modified
4. This item will also be kept in the list without any changes
5. This brand new item was added to the end of the list
